...
from utilities.discrete_log import tate_pairing_pari, weil_pairing_pari
...
class CouplePoint:
    ...
    def tate_pairing(self, other, n):
        """
        The Tate pairing e_n(P, Q) for P = (P1, P2) and Q = (Q1, Q2)
        is defined as

            e_n(P, Q) = e_n(P1, Q1) * e_n(P2, Q2)
            
        The computation assumes that Q is an n-torsion point
        """
        if not isinstance(other, CouplePoint):
            raise TypeError("Both inputs must be couple points")
        ...
        ePQ1 = tate_pairing_pari(Q1, P1, n)
        ePQ2 = tate_pairing_pari(Q2, P2, n)
